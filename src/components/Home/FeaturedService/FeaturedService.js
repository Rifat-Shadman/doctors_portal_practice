...
import featured from '../../../images/webpage.jpg'
const FeaturedService = () => {
    return (
        <section className="features-service pb-0 pb-md-5 my-5" style={{height:'fit-content',width:'auto' ,border:'3px solid red'}}>
            <div className="container ">
                <div className="row mb-5">
                    <div className="col-md-5 mb-4 m-md-0">
                        <img className="img-fluid mt-5" style={{height:'80%', width:'100%'}} src={featured} alt=""/>
                    </div>
                    <div className="col-md-7 align-self-center">
                        <h1>Complete MakeOver For Your Website</h1>
